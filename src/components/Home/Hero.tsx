...
export default function Hero () {
    return (
        <header className='grid grid-cols-1 lg:grid-cols-2 min-h-max [&>*]:place-self-center [&>*]: gap-y-14 px-8 py-10 md:px-16 lg:min-h-[85vh] mb-5'>
            <div>
                <div className=''>
                    <h2 className='text-3xl md:text-5xl leading-12 font-bold mb-5'>Welcome on <span className="text-violet-800">Space</span>In</h2>
                ...
                <div className="mt-7 md:mt-10 bg-violet-800 text-white hover:bg-white hover:text-violet-600 border border-violet-800 rounded-lg w-fit cursor-pointer font-semibold px-5 py-1.5 " >
