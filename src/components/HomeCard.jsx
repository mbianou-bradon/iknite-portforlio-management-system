            ...
            <div className="w-full max-w-[18rem] border border-violet-600 bg-white rounded-lg py-5">
                <div>
                    ...
                    <div className="content py-3 px-4">
                        ...
                        <div className="body">
                            <h2 className="engineer__name text-xl font-semibold mt-2 mb-1">{props.name}</h2>
                            <h2 className="engineer__position text-[0.8rem] text-slate-500 mb-2">{props.position}</h2>
                            <h2 className="engineer__description text-xs w-[90%]">{props.description}</h2>
                        </div>
                    </div>
